...
public class Professore extends Persona{
    ...
    public Professore(String nome, String cognome, int difficolta, int hpMax) {
        super(nome, cognome);
        if (difficolta <= 0)
            throw new IllegalArgumentException("difficoltà negativa");
        if (hpMax <= 0)
            throw new IllegalArgumentException("resistenza negativa");
    ...
    public int getHpProfessore() { return hpProfessore; }
