...
public class GameLoop {
    ...
    private record Azione(String etichetta, Tipo tipo, Stanza destinazione, TipoItem tipoItem,
        ...
        static Azione esame(String e) {
            return new Azione(e, Tipo.ESAME, null, null, null);
        }

        static Azione riposo(String e) {
            return new Azione(e, Tipo.RIPOSO, null, null, null);
        }

        static Azione esci(String e) {
            return new Azione(e, Tipo.ESCI, null, null, null);
        }

        static Azione movimento(Stanza d, String e) {
            return new Azione(e, Tipo.MOVIMENTO, d, null, null);
        }

        static Azione acquisto(TipoItem t, String e) {
            return new Azione(e, Tipo.ACQUISTO, null, t, null);
        }

        static Azione uso(Consumabile c, String e) {
            return new Azione(e, Tipo.USA_ITEM, null, null, c);
        }
    }
}